...
export async function addApp(body: API.AppAddRequest, options?: { [key: string]: unknown }) {
...
export async function deleteAppByAdmin(body: API.DeleteRequest, options?: { [key: string]: unknown }) {
...
export async function deleteApp(body: API.DeleteRequest, options?: { [key: string]: unknown }) {
...
export async function deployApp(body: API.AppDeployRequest, options?: { [key: string]: unknown }) {
...
export async function updateApp(body: API.AppUpdateRequest, options?: { [key: string]: unknown }) {
