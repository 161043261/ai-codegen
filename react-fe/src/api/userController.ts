...
export async function deleteUser(body: API.DeleteRequest, options?: { [key: string]: unknown }) {
...
export async function userLogin(body: API.UserLoginRequest, options?: { [key: string]: unknown }) {
...
export async function updateUser(body: API.UserUpdateRequest, options?: { [key: string]: unknown }) {
