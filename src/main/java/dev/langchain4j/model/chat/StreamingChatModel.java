...
public interface StreamingChatModel {
   ...
   * @param handler a {@link StreamingChatResponseHandler} that will handle streaming response from
   *     the LLM
   */
  default void chat(ChatRequest chatRequest, StreamingChatResponseHandler handler) {

    ChatRequest finalChatRequest =
        ChatRequest.builder()
    ...
    StreamingChatResponseHandler observingHandler =
        new StreamingChatResponseHandler() {
          ...
          public void onError(Throwable error) {
            ChatModelListenerUtils.onError(
                error, finalChatRequest, provider(), attributes, listeners);
